...
! function(a) {
    ...
    function h(f, i) {
        function k(a) {
            ...
            var b = a / P,
                c = b * R;
            b > 1 && (c += (Math.ceil(b) - 1) * T), r(i.ratedFill), c = i.rtl ? 100 - c : c, X.css("width", c + "%")
        }
        function l() {
        ...
        function r(a) {
            if (i.multiColor) {
                var b = Z - Y,
                    c = b / i.maxValue * 100,
                    d = i.multiColor || {},
                    e = d.startColor || o.startColor,
                    h = d.endColor || o.endColor;
                a = g(e, h, c)
            } else _ = a;
            i.ratedFill = a;
            var j = (i.rtl ? W : X).find("svg");
            return j.attr({
                fill: i.ratedFill
            }), f
        }
    ...
    function k(b) {
        ...
        return b = a.extend({}, n, b), a.each(d, function() {
            var d = i(this, c);
            if (!d) return new h(a(this), a.extend({}, b))
        })
    }
    function l() {
